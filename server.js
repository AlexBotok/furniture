...
const { upload, resizeImage } = require("./models/upload");
const { verifyToken, verifyUserLogin } = require("./models/verifyToken");
...
const start = async () => {
  try {
    await mongoose.connect(
      "mongodb+srv://admin:adminalex@cluster0.on6ri4v.mongodb.net/sitedb"
    );
